...
\begin{exo}
%olympiades lelingrad 1980, facile, angle inscrit et triangles semblables à la fin. Fan de géom 273. Facile. TODO : figure
...
\begin{center}
\begin{tikzpicture}
\tkzDefPoint(0,0){A}\tkzDefPoint(5,0){B} \tkzDefPoint(6,3){C} \tkzDefPoint(1,3){D}
\tkzDefBarycentricPoint(A=1,B=3)\tkzGetPoint{P}
\tkzDefBarycentricPoint(A=1,D=4)\tkzGetPoint{R}
\tkzDefCircle[circum](A,P,R) \tkzGetPoint{O}
\tkzDrawPolygon[very thick](A,B,C,D)
\tkzDrawSegment(A,C)
\tkzDrawCircle(O,A)
\tkzDrawPoints(A,B,C,D,P,R)
\end{tikzpicture}
\end{center}
\end{exo}
