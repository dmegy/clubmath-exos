...
\begin{exo}[Formule de doublement d'angle]
\begin{center}
\begin{tikzpicture}
\end{tikzpicture}
\end{center}
...
\begin{exo}[Autres formules de trigo déguisées]
\begin{center}
\begin{tikzpicture}
\end{tikzpicture}
\end{center}
...
\begin{exo}[Une application de la loi des sinus]
\begin{center}
\begin{tikzpicture}
\end{tikzpicture}
\end{center}
...
\begin{exo}[Une application du théorème de Stewart]
\begin{center}
\begin{tikzpicture}
\end{tikzpicture}
\end{center}
